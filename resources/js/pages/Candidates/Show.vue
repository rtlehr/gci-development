        ...
        <div class="rounded-2xl border bg-background p-6 shadow-sm">
            <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                ...
                <div class="flex flex-wrap gap-2">
                    <Button as-child variant="outline"><Link href="/candidates">Back to Candidates</Link></Button>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <div class="rounded-2xl border bg-background p-6 shadow-sm space-y-4">
                ...
                <div v-if="candidate.person?.id" class="pt-2">
                    <Button as-child variant="outline" size="sm"><Link :href="`/people/${candidate.person.id}`">View Person</Link></Button>
                </div>
            </div>
            ...
            <div class="rounded-2xl border bg-background p-6 shadow-sm space-y-4">
                ...
                <div v-if="candidate.position?.id" class="pt-2">
                    <Button as-child variant="outline" size="sm"><Link :href="`/positions/${candidate.position.id}`">View Position</Link></Button>
                </div>
            </div>
        </div>
