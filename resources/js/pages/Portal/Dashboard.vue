...
<template>
    ...
    <section class="border-b border-[#e3e3e3] bg-white">
        <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <p class="mt-3 max-w-2xl text-[#3a3a3a]/70">
                Review your alerts, requests, assigned work, and positions from one place.
            </p>
        </div>
    </section>
    ...
    <div class="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <Link href="/portal/tickets" class="rounded-xl border border-[#e3e3e3] bg-white p-5 shadow-sm transition hover:-translate-y-0.5">
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            ...
            <MySubmittedTickets :tickets="submittedTickets" />
        </div>
