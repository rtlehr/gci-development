<template>
    <PageContainer>
        <ListToolbar
            ...
            create-href="/portal/candidates/create"
                        ...
                        >
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    ...
                                    >
                                        <Link :href="`/portal/candidates/${candidate.id}/edit`">
                                            Edit
                                        </Link>
                                    </DropdownMenuItem>
...
function saveColumnPreferences(updatedColumns = columnsForSettings.value) {
    ...
    router.post('/portal/candidates/preferences', {
...
function resetPreferencesOnServer() {
    router.delete('/portal/candidates/preferences', {
        preserveScroll: true,
    })
}
...
function confirmDelete() {
    ...
    router.delete(`/portal/candidates/${candidateToDelete.value}`, {
        preserveScroll: true,
