<template>
    <PageContainer size="full">
        <ListToolbar
            ...
            create-href="/portal/people/create"
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    ...
                                    <DropdownMenuItem as-child v-if="can(Permissions.PEOPLE_UPDATE)">
                                        <Link :href="`/portal/people/${person.id}/edit`">
                                            Edit
                                        </Link>
                                    </DropdownMenuItem>
...
function saveColumnPreferences(updatedColumns = columnsForSettings.value) {
    ...
    router.post('/portal/people/preferences', {
        visible_columns: settingsForm.visibleColumns,
        column_order: settingsForm.columnOrder,
    }, {
        preserveScroll: true,
...
function resetPreferencesOnServer() {
    router.delete('/portal/people/preferences', {
        preserveScroll: true,
    })
}
...
function confirmDelete() {
    ...
    router.delete(`/portal/people/${personToDelete.value}`, {
        preserveScroll: true,
